...
public class RollUp {
	...
	public static void main(String[] args){
		...
		ru.dice(datasource + "_formated", filterName, filterOperator, filterValue);
		ru.generateCube(datasource + "_formated_dice_rollup", dimensions, "_value", "cod_produto");
...
/*	public void dice(String datasource, String[] dimensions, String value, String[] filterName, String[] filterOperator, String[] filterValue){
		datasource = datasource + "_formated";
		DBCollection collection = dbcon.getDb().getCollection(datasource);
		DBCollection insertCollection = dbcon.getDb().getCollection(datasource + "_rollup_dice");
